...
=================================================================
HashTux requests to Twitter API are handled in the module `twitter_search.erl`. HashTux requests to Twitter use the REST [Search API] (https://dev.twitter.com/rest/public/search).
